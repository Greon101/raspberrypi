...
default_args = {
 ...
 'solutionname': 'greonproject-4ce8',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_greonproject-4ce8", default_args=default_args, tags=["tml_system_step_1_getparams_dag_greonproject-4ce8"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
